...
class Abe:
    ...
    def handle_chains(abe, page):
        ...
        for row in rows:
            ...
            '       <div class="panel-body">', height, '</div>'
            '    </div>'
            '   </div>'
            ...
            '       <div class="panel-body">', format_satoshis(satoshis, chain), '</div>'
            '    </div>'
            '   </div>'
            ...
            '       <div class="panel-body">', format_satoshis(satoshis-totalcold, chain), '</div>'
            '    </div>'
            '   </div>'
            '</div>']
    ...
    def _show_block(abe, where, bind, page, dotdotblock, chain):
        ...
        if chain is None:
            ...
            page['title'] = [escape(chain['name'] + ' - All Blocks'), ' ', height]
